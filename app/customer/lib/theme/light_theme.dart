...
ThemeData light = ThemeData(
  ...
  primaryColor: const Color(0xFFE32404),
  secondaryHeaderColor: const Color(0x9BE32404),
  ...
  textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: const Color(0xFFE32404))),
  colorScheme: const ColorScheme.light(
          primary: Color(0xFFE32404),
          tertiary: Color(0xff102F9C),
          tertiaryContainer: Color(0xff8195DB),
          secondary: Color(0x9BE32404))
