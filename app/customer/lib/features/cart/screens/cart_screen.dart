...
import 'package:yum2go_v3_customer/features/cart/widgets/cart_product_widget.dart';
import 'package:yum2go_v3_customer/features/cart/widgets/cart_suggested_item_view_widget.dart';
import 'package:yum2go_v3_customer/features/cart/widgets/checkout_button_widget.dart';
import 'package:yum2go_v3_customer/features/cart/widgets/pricing_view_widget.dart';
...
import 'package:yum2go_v3_customer/common/widgets/web_constrained_box.dart';
                                                                ...
                                                                WebConstrainedBox(
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        ConstrainedBox(
                                                                          constraints:
                                                                              BoxConstraints(maxHeight: isDesktop ? MediaQuery.of(context).size.height * 0.4 : double.infinity),
                                                                          child:
                                                                              ListView.builder(
                                                                            physics: isDesktop
                                                                            ...
                                                                            itemBuilder:
                                                                              ...
                                                                              return CartProductWidget(
                                                                                ...
                                                                                variationText: cartController.variationText[index],
                                                                              );
                                                                            },
                                                                          ),
                                                                        ),
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            icon:
                                                                                Icon(Icons.add_circle_outline_sharp, color: Theme.of(context).primaryColor),
                                                                            label:
                                                                                Text(
