...
import 'package:yum2go_v3_customer/features/home/widgets/cuisine_card_widget.dart';
import 'package:yum2go_v3_customer/features/search/controllers/search_controller.dart'
    as search;
import 'package:yum2go_v3_customer/features/search/widgets/filter_widget.dart';
import 'package:yum2go_v3_customer/features/search/widgets/search_result_widget.dart';
...
import 'package:yum2go_v3_customer/common/widgets/bottom_cart_widget.dart';
...
class SearchScreenState extends State<SearchScreen> {
  ...
  Future<Iterable<String>> _search(String query) async {
    ...
    return foodsAndRestaurants.toSet().toList();
  }
                                                                  ...
                                                                  ? GridView
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return InkWell(
                                                                          onTap:
                                                                              () {
                                                                            Get.toNamed(RouteHelper.getCuisineRestaurantRoute(cuisineController.cuisineModel!.cuisines![index].id,
