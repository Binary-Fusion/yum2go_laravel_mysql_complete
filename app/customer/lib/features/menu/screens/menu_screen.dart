...
import 'package:yum2go_v3_customer/features/language/widgets/language_bottom_sheet_widget.dart';
import 'package:yum2go_v3_customer/features/menu/widgets/portion_widget.dart';
                      ...
                      (Get.find<SplashController>()
                          ...
                          ? PortionWidget(
                              ...
                              onTap: () {
                                launchUrl(
                                  Uri.parse(
                                      "https://yum2go.com/restaurant/apply"),
                                );
                              },
                            )
                          : const SizedBox(),
