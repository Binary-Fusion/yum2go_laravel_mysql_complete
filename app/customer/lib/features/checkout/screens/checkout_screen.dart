...
import 'package:yum2go_v3_customer/features/checkout/widgets/bottom_section_widget.dart';
import 'package:yum2go_v3_customer/features/checkout/widgets/checkout_screen_shimmer_view.dart';
import 'package:yum2go_v3_customer/features/checkout/widgets/order_place_button.dart';
import 'package:yum2go_v3_customer/features/checkout/widgets/top_section_widget.dart';
...
import 'package:yum2go_v3_customer/common/widgets/not_logged_in_screen.dart';
        ...
        for (int i = 0;
          ...
          if (cartModel.variations![index][i]!) {
            variationPrice += (PriceConverter.convertWithDiscount(
                    cartModel.product!.allVariations[index].variationValues![i]
                            .optionPrice ??
                        0,
                    discount,
                    discountType,
                    isVariation: true)! *
                cartModel.quantity!);
            variationDiscount += (cartModel.product!.allVariations[index]
                    .variationValues![i].optionPrice ??
                0 * cartModel.quantity!);
          }
        }
