...
class RestaurantService implements RestaurantServiceInterface {
  ...
  @override
  Future<List<Restaurant>?> getNationalRestaurantList(String type) async {
    return await restaurantRepositoryInterface.getRestaurantList(
        type: type, isNational: true);
  }

  @override
  Future<List<Restaurant>?> getLocalRestaurantList(String type) async {
    return await restaurantRepositoryInterface.getRestaurantList(
        type: type, isLocal: true);
  }
