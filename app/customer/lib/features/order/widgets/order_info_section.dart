...
import 'package:yum2go_v3_customer/features/order/widgets/log_bottom_sheet_widget.dart';
import 'package:yum2go_v3_customer/features/order/widgets/offline_info_edit_dialog.dart';
...
import 'package:yum2go_v3_customer/features/order/widgets/delivery_details.dart';
import 'package:yum2go_v3_customer/features/order/widgets/order_product_widget.dart';
import 'package:yum2go_v3_customer/features/review/widgets/review_dialog_widget.dart';
...
import 'package:yum2go_v3_customer/features/chat/widgets/image_dialog_widget.dart';
import 'package:yum2go_v3_customer/helper/date_converter.dart';
import 'package:yum2go_v3_customer/helper/image_helper.dart';
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          (pastOrder)
              ? CustomImageWidget(
                  image: order.restaurant!.fullCover,
                  height: 160,
            ...
            child:
              ...
              order.restaurant != null
                  ? Row(children: [
                      ClipOval(
                          child: CustomImageWidget(
                        image: getImageUrl(order.restaurant!.logo!,
