...
import 'package:yum2go_v3_customer/features/order/widgets/address_details_widget.dart';
                    ...
                    children: [
                      ...
                      Row(children: [
                        ClipOval(child: Builder(builder: (context) {
                          final baseUrls = Get.find<SplashController>()
                              .configModel!
                              .baseUrls!;
                          final image = takeAway
                              ? track.restaurant != null
                                  ? track.restaurant!.logo
                                  : ''
                              : track.deliveryMan!.image;
                          final fullUrl = takeAway
                              ? image
                              : "${baseUrls.deliveryManImageUrl!}/$image";
