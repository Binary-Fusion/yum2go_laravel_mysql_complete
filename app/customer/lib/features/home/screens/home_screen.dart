...
import 'package:yum2go_v3_customer/common/widgets/customizable_space_bar_widget.dart';
...
import 'package:yum2go_v3_customer/features/home/screens/theme1_home_screen.dart';
import 'package:yum2go_v3_customer/features/home/screens/web_home_screen.dart';
...
import 'package:yum2go_v3_customer/features/home/widgets/cashback_dialog_widget.dart';
import 'package:yum2go_v3_customer/features/home/widgets/cashback_logo_widget.dart';
import 'package:yum2go_v3_customer/features/home/widgets/popular_restaurants_view_widget.dart';
import 'package:yum2go_v3_customer/features/home/widgets/refer_bottom_sheet_widget.dart';
...
import 'package:yum2go_v3_customer/helper/auth_helper.dart';
...
import '../widgets/app/category_widget.dart';
import '../widgets/app/phone_appbar.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload) async {
    Future.value([
      ...
      // ],
      Get.find<RestaurantController>()
          .getNationalRestaurantList(reload, 'all', false),
      Get.find<RestaurantController>()
          .getLocalRestaurantList(reload, 'all', false),
        ...
        return GetBuilder<LocalizationController>(
          builder: (localizationController) {
            return Scaffold(
              ...
              backgroundColor: (GetPlatform.isMobile && !kIsWeb)
              ...
              body: SafeArea(
                ...
                child: RefreshIndicator(
                  onRefresh: () async {
                    ...
                    await Get.find<RestaurantController>()
                        .getNationalRestaurantList(true, 'all', false);
                    await Get.find<RestaurantController>()
                        .getLocalRestaurantList(true, 'all', false);
