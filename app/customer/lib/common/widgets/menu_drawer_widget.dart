import 'package:yum2go_v3_customer/common/widgets/hover_widgets/on_hover_widget.dart';
  ...
  void initState() {
    ...
    if (Get.find<SplashController>()
      ...
      _menuList.add(Menu(
        ...
        onTap: () {
          // return Get.toNamed(RouteHelper.getRestaurantRegistrationRoute());
          launchUrl(
            Uri.parse('https://yum2go.com/restaurant/apply'),
