...
import 'package:yum2go_v3_customer/common/widgets/image_viewer_screen_widget.dart';
import 'package:yum2go_v3_customer/common/widgets/not_found_widget.dart';
import 'package:yum2go_v3_customer/features/auth/controllers/auth_controller.dart';
import 'package:yum2go_v3_customer/features/cart/screens/cart_screen.dart';
import 'package:yum2go_v3_customer/features/checkout/domain/models/place_order_body_model.dart';
import 'package:yum2go_v3_customer/features/checkout/domain/models/pricing_view_model.dart';
import 'package:yum2go_v3_customer/features/checkout/screens/checkout_screen.dart';
import 'package:yum2go_v3_customer/features/checkout/screens/offline_payment_screen.dart';
import 'package:yum2go_v3_customer/features/checkout/screens/order_successful_screen.dart';
import 'package:yum2go_v3_customer/features/checkout/screens/payment_screen.dart';
import 'package:yum2go_v3_customer/features/checkout/screens/payment_webview_screen.dart';
import 'package:yum2go_v3_customer/features/home/screens/map_view_screen.dart';
import 'package:yum2go_v3_customer/features/html/enums/html_type.dart';
import 'package:yum2go_v3_customer/features/html/screens/html_viewer_screen.dart';
import 'package:yum2go_v3_customer/features/language/screens/language_screen.dart';
import 'package:yum2go_v3_customer/features/location/screens/access_location_screen.dart';
import 'package:yum2go_v3_customer/features/location/screens/map_screen.dart';
import 'package:yum2go_v3_customer/features/location/screens/pick_map_screen.dart';
import 'package:yum2go_v3_customer/features/notification/domain/models/notification_body_model.dart';
import 'package:yum2go_v3_customer/features/notification/screens/notification_screen.dart';
import 'package:yum2go_v3_customer/features/onboard/screens/onboarding_screen.dart';
import 'package:yum2go_v3_customer/features/order/screens/guest_track_order_screen.dart';
import 'package:yum2go_v3_customer/features/order/screens/order_details_screen.dart';
import 'package:yum2go_v3_customer/features/order/screens/order_screen.dart';
import 'package:yum2go_v3_customer/features/order/screens/order_tracking_screen.dart';
import 'package:yum2go_v3_customer/features/order/screens/refund_request_screen.dart';
import 'package:yum2go_v3_customer/features/profile/screens/profile_screen.dart';
import 'package:yum2go_v3_customer/features/profile/screens/update_profile_screen.dart';
import 'package:yum2go_v3_customer/features/refer%20and%20earn/screens/refer_and_earn_screen.dart';
import 'package:yum2go_v3_customer/features/restaurant/screens/all_restaurant_screen.dart';
import 'package:yum2go_v3_customer/features/restaurant/screens/campaign_screen.dart';
import 'package:yum2go_v3_customer/features/restaurant/screens/restaurant_product_search_screen.dart';
import 'package:yum2go_v3_customer/features/restaurant/screens/restaurant_screen.dart';
import 'package:yum2go_v3_customer/features/review/domain/models/rate_review_model.dart';
import 'package:yum2go_v3_customer/features/review/screens/rate_review_screen.dart';
import 'package:yum2go_v3_customer/features/review/screens/review_screen.dart';
import 'package:yum2go_v3_customer/features/search/screens/search_screen.dart';
...
import 'package:yum2go_v3_customer/features/address/screens/add_address_screen.dart';
import 'package:yum2go_v3_customer/features/address/screens/address_screen.dart';
import 'package:yum2go_v3_customer/features/auth/domain/models/social_log_in_body_model.dart';
import 'package:yum2go_v3_customer/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:yum2go_v3_customer/features/auth/screens/restaurant_registration_screen.dart';
import 'package:yum2go_v3_customer/features/auth/screens/sign_in_screen.dart';
import 'package:yum2go_v3_customer/features/auth/screens/sign_up_screen.dart';
import 'package:yum2go_v3_customer/features/business/screens/business_plan_screen.dart';
import 'package:yum2go_v3_customer/features/business/screens/subscription_success_screen.dart';
import 'package:yum2go_v3_customer/features/category/screens/category_product_screen.dart';
import 'package:yum2go_v3_customer/features/category/screens/category_screen.dart';
import 'package:yum2go_v3_customer/features/chat/domain/models/conversation_model.dart';
import 'package:yum2go_v3_customer/features/chat/screens/chat_screen.dart';
import 'package:yum2go_v3_customer/features/chat/screens/conversation_screen.dart';
import 'package:yum2go_v3_customer/features/coupon/screens/coupon_screen.dart';
import 'package:yum2go_v3_customer/features/cuisine/screens/cuisine_restaurant_screen.dart';
import 'package:yum2go_v3_customer/features/cuisine/screens/cuisine_screen.dart';
import 'package:yum2go_v3_customer/features/dashboard/screens/dashboard_screen.dart';
import 'package:yum2go_v3_customer/features/interest/screens/interest_screen.dart';
import 'package:yum2go_v3_customer/features/loyalty/screens/loyalty_screen.dart';
import 'package:yum2go_v3_customer/features/product/screens/item_campaign_screen.dart';
import 'package:yum2go_v3_customer/features/product/screens/popular_food_screen.dart';
import 'package:yum2go_v3_customer/features/splash/domain/models/deep_link_body.dart';
import 'package:yum2go_v3_customer/features/splash/screens/splash_screen.dart';
import 'package:yum2go_v3_customer/features/support/screens/support_screen.dart';
import 'package:yum2go_v3_customer/features/update/screens/update_screen.dart';
import 'package:yum2go_v3_customer/features/verification/screens/forget_pass_screen.dart';
import 'package:yum2go_v3_customer/features/verification/screens/new_pass_screen.dart';
import 'package:yum2go_v3_customer/features/verification/screens/verification_screen.dart';
import 'package:yum2go_v3_customer/features/wallet/screens/wallet_screen.dart';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () => getRoute(
              AllRestaurantScreen(
                isPopular: Get.parameters['page'] == 'popular',
                isNational: Get.parameters['page'] == 'national',
                isLocal: Get.parameters['page'] == 'local',
