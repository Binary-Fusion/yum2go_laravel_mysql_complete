                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          CustomTimePickerWidget(
                                            ...
                                            onTimeChanged: (time) => _product!
                                                .availableTimeStarts = time,
                                          ),
                                          const SizedBox(
                                              height: Dimensions
                                                  .paddingSizeOverExtraLarge),
                          ...
                          !restController.isLoading
                              ? CustomButtonWidget(
                                  ...
                                  onPressed: () {
                                    ...
                                    try {
                                      itemStock = int.parse(
                                          _stockTextController.text.trim());
                                    } catch (e) {
                                      itemStock = 0;
                                    }
                                    ...
                                    if (defaultDataNull) {
                                      ...
                                      showCustomSnackBar(
                                          'enter_food_discount'.tr);
                                    } else if (categoryController
                                            .categoryIndex ==
                                        0) {
                                      showCustomSnackBar(
                                          'select_a_category'.tr);
                                    } else if (_stockTextController
                                            .text.isEmpty &&
                                        restController.stockTypeIndex != 0) {
                                      showCustomSnackBar(
                                          'enter_the_item_stock'.tr);
                                    ...
                                    } else if (_product!.availableTimeEnds ==
                                        null) {
                                      showCustomSnackBar('pick_end_time'.tr);
                                    } else {
                                      _product!.veg =
                                          restController.isVeg ? 1 : 0;
                                      _product!.isHalal =
                                      ...
                                      _product!.stockType = restController
                                                  .stockTypeIndex ==
                                              0
                                          ? 'unlimited'
                                      ...
                                      if (restController
                                        ...
                                        _product!.variations = restController
                                            .variationList!
                                            .map((e) => e.toVariation())
                                            .toList();
                                        // for (var variation
                                      ...
                                      for (int index = 0;
                                        ...
                                        translations.add(Translation(
                                          locale: _languageList[index].key,
                                          key: 'description',
                                          value: _descriptionControllerList[
                                                      index]
                                                  .text
                                                  .trim()
                                                  .isNotEmpty
