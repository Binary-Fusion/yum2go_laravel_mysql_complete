...
class _RestaurantRegistrationScreenState
  ...
  final TextEditingController _dbaBusinessNameController =
  ...
  final FocusNode _dbaBusinessNameFocus = FocusNode();
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomTextFieldWidget(
                                          ...
                                          nextFocus: _dbaBusinessNameFocus,
                                        ),
                                        const SizedBox(
                                            height:
                                                Dimensions.paddingSizeSmall),
                                        const _LabelTextWidget(
                                          text: 'DBA Business Name',
                                        ),
                                        CustomTextFieldWidget(
                                          hintText: 'Doing Business As',
                                          controller:
                                              _dbaBusinessNameController,
                                          focusNode: _dbaBusinessNameFocus,
                                          nextFocus: _phoneFocus,
                                        ),
                                        const SizedBox(
                                            height:
                            ...
                            ? CustomButtonWidget(
                                ...
                                onPressed: () {
                                  ...
                                  String dbaBusinessName =
                                      _dbaBusinessNameController.text.trim();
                                  ...
                                  final contractData = RiskDiscloserData(
                                    legalBusinessName: businessName,
                                    dbaBusinessName: dbaBusinessName,
                                    businessContactName: '$fName $lName',
                                    businessContactEmail: email,
                                    businessContactTelephone: phoneWithCountryCode,
                                    printedName: '$fName $lName',
                                    businessTitle: 'Owner',
                                  );
