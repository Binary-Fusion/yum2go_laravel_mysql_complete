...
class AuthService implements AuthServiceInterface {
  ...
  Future<Response> registerRestaurant(
    ...
    RiskDiscloserData riskDiscloserData,
  ) async {
    ...
    if (response.statusCode == 200) {
      ...
      Get.off(() => RiskDisclosurePage(data: riskDiscloserData.copyWith(
  ...
  Future<FilePickerResult?> picFile(MediaData mediaData) async {
    ...
    if (result != null && result.files.isNotEmpty) {
      if (result.files.single.size > AppConstants.maxFileSizeInBytes) {
        result = null;
