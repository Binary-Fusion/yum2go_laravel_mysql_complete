...
class RouteHelper {
  ...
  static const String riskDiscloser = '/risk-discloser';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      name: riskDiscloser,
      page: () => RiskDisclosurePage(
        data: Get.parameters['data'] != 'null'
            ? RiskDiscloserData.fromJson(jsonDecode(utf8.decode(base64Url
  ...
  static String getRiskDiscloserRoute(RiskDiscloserData riskDiscloserData) {
    return '$riskDiscloser?data=${base64Encode(utf8.encode(jsonEncode(riskDiscloserData)))}';
  }
