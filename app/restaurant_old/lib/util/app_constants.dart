...
class AppConstants {
  static const String appName = 'YUM2GO - BUSINESS';
  ...
  static const String merchantUri = '/api/v1/vendor/merchant-agreement';
  ...
  static const String signupsFee =
      '/api/v1/auth/vendor/signup-fee/payment';
