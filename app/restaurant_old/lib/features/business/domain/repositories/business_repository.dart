...
class BusinessRepository implements BusinessRepositoryInterface<PackageModel> {
  ...
  @override
  Future<Response> registrationFeeUrl(String id, String? paymentName) async {
    return await apiClient.postData(AppConstants.signupsFee, {'restaurant_id': id, 'payment_gateway': paymentName});
  }
