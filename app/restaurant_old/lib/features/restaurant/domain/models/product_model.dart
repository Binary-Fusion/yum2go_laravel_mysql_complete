...
import 'package:stackfood_multivendor_restaurant/helper/extensions/list_ext.dart';
...
class Variation {
  ...
  Variation.fromJson(Map<String, dynamic> json) {
    ...
    if (json['values'] != null) {
      variationValues = [];
      (json['values'] as List).forEachIndexed((_, v) {
...
class VariationOption {
  ...
  VariationOption.fromJson(Map<String, dynamic> json) {
    ...
    if (json['child'] != null) {
      child = [];
      (json['child'] as List).forEachIndexed((_, v) {
  ...
  Option toOption() {
    return Option(
      optionNameController: TextEditingController(text: level),
      optionPriceController: TextEditingController(text: optionPrice),
      optionStockController: TextEditingController(text: totalStock),

      optionId: optionId,
      child: child?.map((e) => e.toVariationModel(optionId)).toList(),
    );
  }
}
